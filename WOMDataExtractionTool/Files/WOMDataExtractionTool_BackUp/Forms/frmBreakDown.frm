...
Begin VB.Form frmBreakDown 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSForms.CommandButton cmdSearch 
         ...
         Accelerator     =   83
         MouseIcon       =   "frmBreakDown.frx":1052
...
Private Sub Form_Load()
    ...
    Me.dtTo.Value = Date
    Call subFormatGrid(flxSummaryDetail, "maintenance")
...
Private Sub LoadFlexBreakdownView()
    ...
    If frmBreakDown.cboType.Text <> "ForkLift" Then
    ...
    End If
        ...
        Call subFormatGrid(flxSummaryDetail_forkLift_Battery, IIf(Me.cboType.Text = "ForkLift", "summary_forklift", "summary"))
        Call subFormatGrid(flxSummaryDetail_forkLift_Diesel, IIf(Me.cboType.Text = "ForkLift", "summary_forklift", "summary"))
       Call subFormatGrid(flxSummaryDetail, "summary")
        
        
        Select Case Me.cboType.Text
                Case "ForkLift" '--------------------FORKKLIFT
                         '---------FORKKLIFT DIESEL
