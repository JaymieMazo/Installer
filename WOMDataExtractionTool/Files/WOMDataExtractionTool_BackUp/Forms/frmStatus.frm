...
Private Sub LoadFlexDailyReportStatus(strWhere As String)
    ...
    Set rsFlex = cls_GetDetails.pfLoadStatus(Me.cboType.Column(0), strWhere)
...
LDErr:
    ...
    GoTo LDExit
End Sub
Private Sub LoadFlexDailyReportStatus_forklift(strWhere As String)
    Dim rsFlex As ADODB.Recordset
    Dim lngLoop, i, c As Long
    Dim lngrow As Long
    Dim lngNo As Long
...
Private Sub cmdSearch_Click()
    ...
    strWhere = strWhere & " AND CONVERT(VARCHAR(20),DateOfWorkOrder,111)  <= '" & dtTo.Value & "'"
        ...
        If Me.cboType.Text = "ForkLift" Then
                Call LoadFlexDailyReportStatus_forklift(strWhere)
        Else
                Call LoadFlexDailyReportStatus(strWhere)
        End If
