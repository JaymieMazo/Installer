...
Dim strRemarks As String
    ...
    If KeyAscii = 13 Then 'ENTER
        ...
        End If
        MsgBox "Data Saved !", vbInformation, "System Information"
    End If
    ...
    If KeyAscii = 13 Then 'ENTER
        ...
        ElseIf flxMonitoring.Col = 11 Then 'EQUIPMENTSTATUS
            ...
            If rs.RecordCount = 0 Then 'Insert
                ...
                InsertSQL = ""
                InsertSQL = "INSERT INTO WOMDE_ItemStatus"
                InsertSQL = InsertSQL & " (ItemCode,ItemName,EquipmentStatus)"
                InsertSQL = InsertSQL & " VALUES"
            ...
            Else ' Update
                ...
                UpdateSQL = ""
                UpdateSQL = "UPDATE WOMDE_ItemStatus"
                ...
                UpdateSQL = UpdateSQL & " WHERE ItemCode = '" & strMCN & "'"
...
Call Connect
    If cboCompany.ListIndex < 0 Then
        MsgBox "Please select a Company", vbInformation, "System Information"
    ElseIf txtPRSNo = "" And cboDepartment = "" And cboType = "" And cboStatus = "" And txtMachineNo = "" And txtMachineName = "" And txtInCharge = "" Then
        MsgBox "Please enter atleast one more value for search !", vbInformation, "System Information"
    ElseIf dtFrom.Value > dtTo.Value Then
        MsgBox "Date to must be greater than or equal to Date from !", vbInformation, "System Information"
    Else
        ...
        If txtMachineNo.Text <> "" Then
            strSQLwhere = strSQLwhere & "AND WorkOrderPRS.ItemCode LIKE '%" & txtMachineNo.Text & "%' "
        End If
        
        If txtMachineName.Text <> "" Then
             strSQLwhere = strSQLwhere & "AND WorkOrderPRS.ItemName LIKE '%" & txtMachineName.Text & "%' "
        End If
        ...
        If cboCompany.ListIndex = 0 Then 'Wukong
            Set rs = cls_GetDetails.pfLoadPRSMonitoring("004", "wkn-appserver", strSQLwhere)
        ElseIf cboCompany.ListIndex = 1 Then 'Scad
            Set rs = cls_GetDetails.pfLoadPRSMonitoring("001", "a-sv17", strSQLwhere)
        ElseIf cboCompany.ListIndex = 2 Then 'Hti
            Set rs = cls_GetDetails.pfLoadPRSMonitoring("002", "jd-004", strSQLwhere)
        End If
