...
Begin VB.MDIForm FM_Main 
   ...
   Begin VB.Menu mnuFile 
      ...
      Begin VB.Menu mnuBreakdown 
         Caption         =   "Breakdown Work Order"
      End
      Begin VB.Menu mnuStatusView 
         Caption         =   "Daily Report Status"
      End
...
Private Sub mnuExit_Click()
    If MsgBox("Do really want to exit the system?", vbYesNo + vbQuestion, "Exit") = vbYes Then
        End
    End If
End Sub
